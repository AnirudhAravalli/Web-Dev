...
app.post("/submit", (req, res) => {
  ...
  //Then:
  const adj_ele = adj[Math.floor(Math.random() * adj.length)];
  const noun_ele = noun[Math.floor(Math.random() * noun.length)];

  const word = `${adj_ele} ${noun_ele}`;
  res.render("index.ejs", {word : word});
